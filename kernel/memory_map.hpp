...
enum class MemoryType {
  ...
  kEfiConversionalMemory,
  kEfiUnusableMemory,
  kEfiACPReclaimMemory,
  kEfiACPMemoryNVS,
  kEfiMemoryMappedIO,
...
inline bool operator==(MemoryType lhs, uint32_t rhs) { return lhs == rhs; }
...
inline bool IsAvailable(MemoryType memory_type) {
  return memory_type == MemoryType::kEfiBootServicesCode ||
         ...
         memory_type == MemoryType::kEfiConversionalMemory;
}
